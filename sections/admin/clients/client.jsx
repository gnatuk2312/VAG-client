...
const AdminClient = () => {
  ...
  const handleEditVisit = () => {
    setVisitModalOptions({ variant: "edit", clientId: _id, visit: {} });
    setVisitModalOpen(true);
  };
  const handleAddNewVisit = () => {
    setVisitModalOptions({ variant: "add", clientId: _id, visit: null });
    setVisitModalOpen(true);
  };
        ...
        <div className="admin-client__visits client-visits">
          ...
          <div className="client-visits__container">
            <div className="client-visits__table-item">
              ...
              <button onClick={handleEditVisit} type="button" className="client-visits__edit-visit">
                <EditIcon />
              </button>
            </div>
            <div className="client-visits__table-item">
